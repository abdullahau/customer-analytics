...
def expected_probability_y_purchase(x, t_x, T, y, t, r, alpha, a, b):
    ...
    If broadcasting, either t or y must be scalar.
    """
...
```{python}
# num_purchases = np.arange(5) # Num of purchases
# expected_probability_purchases = expected_probability_y_purchase(
#     p1x_sample, t_x_sample, T_sample, num_purchases.reshape(-1,1,1), 30, *params
# )
# expected_probability_purchases
```
