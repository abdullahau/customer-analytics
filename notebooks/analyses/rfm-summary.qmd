...
code-links:
  - text: View source
    icon: file-code
    href: https://github.com/abdullahau/customer-analytics/blob/main/notebooks/analyses/rfm-summary.qmd
---
...
CDNOW = CDNOW.join(unauthorized_resellers.lazy().select("ID"), on="ID", how="anti")
```
