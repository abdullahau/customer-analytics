...
code-links:
  - text: View source
    icon: file-code
    href: https://github.com/abdullahau/customer-analytics/blob/main/notebooks/models/purchasing/bg-bb.qmd
---
...
def compute_mean(x, tx, theta=False):
    ...
    def posterior_func(p_theta):
        return p_theta * marginal_posterior(x, tx, p_theta, theta=theta).item()
