...
code-links:
  - text: View source
    icon: file-code
    href: https://github.com/abdullahau/customer-analytics/blob/main/notebooks/models/retention/subscription-retention.qmd
---
...
![](/references/figures/timeline.png){fig-align="center" width="550"}
...
![](/references/figures/visualize-parameter-estimate-1.png){fig-align="center" width="350"}
...
![](/references/figures/visualize-parameter-estimate-2.png){fig-align="center" width="350"}
...
![](/references/figures/visualize-parameter-estimate-3.png){fig-align="center" width="350"}
...
![](/references/figures/beta-distribution.png){fig-align="center" width="350"}
...
![](/references/figures/four-beta-distributions.png){fig-align="center" width="350"}
...
plt.figure(dpi=120)
cs = plt.contour(gamma_grid, delta_grid, lls, levels=levels, linewidths=0.75, colors="black")
