...
code-links:
  - text: View source
    icon: file-code
    href: https://github.com/abdullahau/customer-analytics/blob/main/notebooks/valuation/cbcv-subscription-based.qmd
---
...
![](/references/figures/num_customer_matrix.png){fig-align="center" width="350"}
